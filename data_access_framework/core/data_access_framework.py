...
from ..models import Game, Studio, Player, GameSession, Genre
from ..business import GameSessionService, AuthService
...
class FrameworkConfig:
    ...
    def __post_init__(self):
        if self.entities is None:
            # Entidades del sistema de videojuegos
            self.entities = ["Game", "Studio", "Player", "GameSession", "Genre"]
...
class DataAccessFramework:
    ...
    def __init__(self, config_path: str = None, **config_overrides):
        ...
        # Servicios de negocio
        self.session_service = GameSessionService(self.entity_manager)
    ...
    def get_repository(self, entity_type: str):
        ...
        Args:
            entity_type: Nombre de la clase de entidad (ej: "Game")
    ...
    def get_service(self, service_name: str):
        ...
        Args:
            service_name: Nombre del servicio ("session", "auth")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats = {
            "entities": {},
            "sessions": {
                "active": len(self.session_service.get_active_sessions()),
                "completed": len(self.session_service.get_completed_sessions())
            },
            "config": {
